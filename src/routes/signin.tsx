...
function SignIn() {
  ...
  return (
    <div className="min-h-screen bg-[#F2F3F2] lg:py-12 lg:px-4 flex flex-col justify-center">
      <div className="animate-page-in min-h-screen bg-white pb-12 lg:max-w-md lg:mx-auto lg:w-full lg:h-[90vh] lg:max-h-[800px] lg:min-h-[650px] lg:py-8 lg:rounded-[30px] lg:overflow-hidden lg:shadow-2xl lg:relative">
