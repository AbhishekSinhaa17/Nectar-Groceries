          ...
          <div className="flex flex-col items-center justify-center flex-1 w-full">
            <div className="relative w-64 h-64 flex items-center justify-center mb-6">
              <div className="absolute inset-0 pointer-events-none">
                <svg
                  className="absolute top-10 right-4 w-12 h-12 text-[#F25A38]"
                  viewBox="0 0 100 100"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="6"
                ...
                <svg
                  className="absolute bottom-16 left-2 w-16 h-16 text-[#5A7CFF]"
                  viewBox="0 0 100 100"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="6"
                ...
                <svg
                  className="absolute bottom-8 right-12 w-8 h-8 text-[#FFBE3B]"
                  viewBox="0 0 100 100"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="6"
