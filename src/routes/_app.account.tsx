...
function Account() {
  ...
  return (
    <div className="animate-page-in min-h-screen bg-white relative pb-24">
      ...
      <div className="mx-auto max-w-2xl px-4 pt-8 lg:px-8 relative z-10">
        <div className="flex items-center gap-4 border-b border-[#E2E2E2] pb-6">
        <div className="grid h-16 w-16 place-items-center rounded-full bg-[#53B175] text-2xl font-bold text-white">
      ...
      <button
        onClick={signOut}
        className="mt-10 flex h-14 w-full items-center justify-center gap-2 rounded-full bg-[#F2F3F2] font-semibold text-[#53B175] transition active:scale-95"
      >
